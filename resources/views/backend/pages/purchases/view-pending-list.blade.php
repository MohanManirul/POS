    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Pending Purchases</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><span>Pending Purchases</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title float-left">Pending Purchases List</h4>
                    <p class="float-right">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                     @if($purchase->status== '0')
                                        <a class="btn btn-danger text-white" href="{{ route('admin.purchases.approve', $purchase->id) }}"
                                        onclick="event.preventDefault(); document.getElementById('delete-form-{{ $purchase->id }}').submit();">
                                            Approve
                                        </a>
                                        @endif
                                        <form id="delete-form-{{ $purchase->id }}" action="{{ route('admin.purchases.approve', $purchase->id) }}" method="POST" style="display: none;">
