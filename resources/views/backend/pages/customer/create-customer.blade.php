        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="{{ route('admin.customers.index') }}">All Customer</a>
...
<div class="main-content-inner">
    ...
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <form id="addCustomers" action="{{ (@$editData)?(route('admin.customers.update', $editData->id)):route('admin.customers.store') }}" method="POST">
                       @csrf
                         @if(isset($editData))
                            @method('PUT')
                        @endif
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-8">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter Customer Name" value="{{@$editData->name}}">
